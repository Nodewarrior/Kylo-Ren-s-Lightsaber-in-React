    ...
    return (
      <div className="App">
        <div class="container">
          ...
          <div class={this.state.toggleValue ? "mask" : "mask mask--on"}>
            <div class="image" style={{backgroundImage: `url(${'http://bookmrk.io/kyloren/kylo_mask.jpg'})` }}></div>
          </div>
          <div class={this.state.toggleValue ? "lightsaber" : "lightsaber lightsaber--on"}>
            <div class="lightsaber__light">
              <div class="lightsaber__line"></div>
              <div class="lightsaber__line"></div>
              <div class="lightsaber__line"></div>
            </div>
            <div class="lightsaber__handle" onClick={this.handleClick}>
              <svg id="handle-svg"
              data-name="Layer 1"
        ...
        <a href="http://dcmjs.com/lightsabers/" target="_blank" class="artist">Handle is made by dcmjs</a>
      </div>
    );
  }
}
